...
namespace DentalLib
{
    partial class PatientChargesCreate
    {
        ...
        public PatientChargesCreate(CommonExchange.SysAccess userInfo, CommonExchange.Patient patientInfo, CommonExchange.Registration regInfo, 
        ...
        private void ClassClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                String strMsg = "Are you sure you want to cancel the creation of a new patient charge information?";
        ...
        private void btnCreateClick(object sender, EventArgs e)
        {
            if (this.ValidateControls())
            {
                try
                {
                    String strMsg = "Are you sure you want to create the new patient charge information?";

                    DialogResult msgResult = MessageBox.Show(strMsg, "Confirm Create", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);

                    if (msgResult == DialogResult.Yes)
                    {
                        strMsg = "The patient charge information has been successfully created.";

                        this.Cursor = Cursors.WaitCursor;

                        _chargesManager.InsertRegistrationDetails(_userInfo, _detailsInfo);
